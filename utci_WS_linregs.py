...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 11:15:20 2024
...
ds1 = xr.open_dataset(r'/home/lab/Desktop/Narayanswamy/heat_stress/heat/ws_daily.nc')
...
var2 = ds1['ws'].isel(time=slice(0,3782))
lats = ds2['lat'].values
lons = ds2['lon'].values
...
ax1.set_title('Linear regression between UTCI and Windspeed', fontsize=20, fontweight='bold', y=1.05)
